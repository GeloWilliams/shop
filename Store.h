...
class Store {
   public:
      ...
      void stockInventory(string product);
      ...
      void inviteCustomers(string customer);
      ...
      void doBusiness(string transaction);

   private:
        
         /* ProductFactory holding all of the Products fread from input file */
         ProductFactory inventory_;

         /** CustomerHouse holding all of the Customers read from input file */
         CustomerHouse customerList_;

         /** ActionStation holding all of the Transactions read from input file */
         ActionStation commands_;
};